...
private:
	...
	static void resolve_overlap(const vec3& Ncoll, float depth, float spring_value, float spring_damper, const vec3& C0, const vec3& P0, vec3& V0, float w0, const vec3& C1, const vec3& P1, vec3& V1, float w1, vec3& Fspring);
